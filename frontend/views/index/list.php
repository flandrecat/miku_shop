...
<div class="list w1210 bc mt10">
    ...
    <div class="breadcrumb">
        <h2>当前位置：<a href="">首页</a> > <a href=""><?=$name->name?></a></h2>
    </div>
    <!-- 面包屑导航 end -->

    <!-- 左侧内容 start -->
    <?=\frontend\widgets\CatlistWidget::widget(['category_id'=>$name->id])?>
    ...
    <div class="list_bd fl ml10 mt10">
        ...
        <div class="goodslist mt10">
            <ul>
                ...
                <li>
                    <dl>
                        <dt><a href="<?=\yii\helpers\Url::to(['index/goods?id='.$model->id])?>"><?=\yii\helpers\Html::img(Yii::$app->params['picUrl'].$model->logo)?></a></dt>
                        <dd><a href="<?=\yii\helpers\Url::to(['index/goods/id='.$model->id])?>"><?=$model->name?></a></dt>
