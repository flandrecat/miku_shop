...
$this->registerJs($js);
$url = \yii\helpers\Url::to(['cart/notice']);
?>
        ...
        <div class="summary">
            ...
            <div class="preview fl">
                <div class="midpic">
                    ...
                    <a href="<?=Yii::$app->params['picUrl'].$model->logo?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
                        <?=\yii\helpers\Html::img(Yii::$app->params['picUrl'].$model->logo,['width'=>'300px'])?>           <!-- 第一幅图片的中图 -->
                    </a>
                </div>
                ...
                <div class="smallpic">
                    ...
                    <div class="smallpic_wrap">
                        <ul>
                            <li class="cur">
                                <a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?=Yii::$app->params['picUrl'].$model->logo?>',largeimage: '<?=Yii::$app->params['picUrl'].$model->logo?>'}"><img src="<?=Yii::$app->params['picUrl'].$model->logo?>"></a>
                            </li>
                            <li>
                                <a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?=Yii::$app->params['picUrl'].$model->logo?>',largeimage: '<?=Yii::$app->params['picUrl'].$model->logo?>'}"><img src="<?=Yii::$app->params['picUrl'].$model->logo?>"></a>
                            </li>
                            <li>
            ...
            <div class="goodsinfo fl ml10">
                <ul>
                    ...
                    <li><span>上架时间：</span><?=date('Y-m-d ',$model->inputtime)?></strong></li>
                    <li class="star"><span>商品评分：</span> <strong></strong><a href="">(已有21人评价)</a></li> <!-- 此处的星级切换css即可 默认为5星 star4 表示4星 star3 表示3星 star2表示2星 star1表示1星 -->
                </ul>
                <form action="<?=$url?>" method="get" class="choose">
                    <ul>
                        ...
                        <li>
                            <dl>
                                ...
                                <dd>
                                    ...
                                    <input type="text" name="pc" value="1" class="amount"/>
